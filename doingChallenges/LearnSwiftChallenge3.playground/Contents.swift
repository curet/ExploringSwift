...
class Library {
    ...
    func checkOut(_ bookId:String, _ person:Person) -> String {
        ...
        let a = "Error: Book already checked out"
        let b = "Successfully checked out"
        let c = "Book doesn't exist"
        
        if catalogue[bookId] == nil{ return c }
        if checkedOutBooks[bookId] != nil{ return a }
        else{
    ...
    func checkIn(_ bookId:String) -> String {
        ...
        let a = "Book doesn't exist"
        let b = "Error: Can't check in a book that hasn't been checked out"
        let c = "Successfully checked in"
        
        if catalogue[bookId] == nil{ return a }
        if checkedOutBooks[bookId] == nil{ return b}
        else {
